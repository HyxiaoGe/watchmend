...
MESSAGES: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "metric.probes": "探针在线",
        "metric.open": "开放异常",
        "metric.recovered": "近 24h 恢复",
        "metric.window": "窗口 {days}d",
    ...
    "en": {
        ...
        "theme.light": "Light",
        "theme.system": "System",
        "banner.ok": "All systems operational",
        "metric.probes": "probes online",
        "metric.open": "open anomalies",
        "metric.recovered": "recovered 24h",
        "metric.window": "window {days}d",
        ...
        "sev.warning": "Warning",
        "banner.issues": "{open} open anomalies need attention",
        ...
        "tab.events": "Events",
        "tab.hygiene": "Hygiene",
        "hero.uptime_label": "{days}d uptime",
